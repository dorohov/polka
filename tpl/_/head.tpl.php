...
<link rel="mask-icon" href="<?=$this->path('favicon');?>/safari-pinned-tab.svg" color="#00794b">
<link rel="shortcut icon" href="<?=$this->path('favicon');?>/favicon.ico">
<meta name="apple-mobile-web-app-title" content="<?=getContact('name');?>">
<meta name="application-name" content="<?=getContact('name');?>">
