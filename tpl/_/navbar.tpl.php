					...
					<div class="<?=$prefix_navbar;?>collapse-inner">	
						<ul class="<?=$prefix_navbar;?>nav">		 	
							...
							<li class="<?=$prefix_navbar;?>nav-item">
								<a href="<?=l(1);?>" class="<?=$prefix_navbar;?>nav-link" ><?=t(1);?></a>
							</li>
							<?
							}
							?>
							<li class="<?=$prefix_navbar;?>nav-item">
								<a href="<?=l(2);?>" class="<?=$prefix_navbar;?>nav-link" ><?=t(2);?></a>
							</li>
							<li class="<?=$prefix_navbar;?>nav-item dropdown">
								...
								<ul class="<?=$prefix_navbar;?>dropdown dropdown-menu">
									<li class="<?=$prefix_navbar;?>dropdown-item">
										<a href="<?=l(14);?>" class="<?=$prefix_navbar;?>dropdown-link" ><?=t(14);?></a>
									</li>
									<li class="<?=$prefix_navbar;?>dropdown-item">
										<a href="<?=l(18);?>" class="<?=$prefix_navbar;?>dropdown-link" ><?=t(18);?></a>
									</li>
								</ul>
									 	
							<li class="<?=$prefix_navbar;?>nav-item">
								<a href="<?=l(6);?>" class="<?=$prefix_navbar;?>nav-link" ><?=t(6);?></a>
							</li>	 	
							<li class="<?=$prefix_navbar;?>nav-item">
								<a href="<?=l(8);?>" class="<?=$prefix_navbar;?>nav-link" ><?=t(8);?></a>
							</li>	 	
							<li class="<?=$prefix_navbar;?>nav-item">
