<?	
	/*$this->tpl(
		...
		array(
			"class_form"=>"inline deliver",
			"prefix_form" => "form__",
			"heading_form" => "Оформить заявку",
			"note_form" => "Вы можете оставить свою заявку<br> и мы обязательно свяжемся с Вами в ближайшее время.",
			"btn_name_form" => "Отправить заявку!",
			"btn_class_form" => "green"
		)
	);
	*/
?>
<form action="#" class="form-site <?=$param["class_form"];?>"  >
	...
	<div class="row <?=$param["prefix_form"];?>row">
		...
		<div class="cols <?=$param["prefix_form"];?>cols">
			<div class="<?=$param["prefix_form"];?>item">
				<input type="email" class="<?=$param["prefix_form"];?>control form-control validate[required,custom[email]]" id="f[email]" name="f[email]" placeholder="Укажите Ваш email"> 
			</div>	
		</div>
		<div class="cols <?=$param["prefix_form"];?>cols">
